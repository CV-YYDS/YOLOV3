        ...
        if self.__visiual:
            ...
            for v in imgs:
                ...
                if bboxes_prd.shape[0] != 0:
                    ...
                    path = os.path.join(cfg.PROJECT_PATH, "data/images/{}".format(v))
...
if __name__ == "__main__":
    ...
    parser.add_argument('--weight_path', type=str, default='/home/lbc/jujinhao/YOLOV3-master/weight/best.pt', help='weight file path')
    parser.add_argument('--visiual', type=str, default='/home/lbc/jujinhao/YOLOV3-master/data/VOCtest-2007/VOCdevkit/VOC2007/JPEGImages ', help='test data path or None')
